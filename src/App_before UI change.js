  ...
  const generateFullNote = () => {
    ...
    clinicalData.sections.forEach((section) => {
      ...
      if (section.questions) {
        ...
        section.questions.forEach((q) => {
          if (!section.isScored) {
            ...
            if (note) {
              // If this question has paragraphBreak, save current paragraph and start new one
      ...
      if (sectionNotes.length > 0) {
        noteParts.push({
          title: section.title,
          paragraphs: sectionNotes, // store as array of paragraphs
        });
      }
    });
  ...
  return (
    <div className="app-container">
      ...
      <header className="app-header">
        <h1>Näsi Medical</h1>
        <p className="app-subtitle">Alaselkäkivun kliininen dokumentaatiotyökalu</p>
      </header>
